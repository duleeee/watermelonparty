  ...
  return (
    <div className="introduction-page">
      <div className="contentw">
        ...
        <h2>What is it?</h2>
        <p>It's a drinking game, or as some call it, a drinking sport. Two mixed-gender teams compete to see who can drink more of the <b>icy, refreshing Vodka and Fanta mix</b> from a big, juicy watermelon on the beach.  Team Beach and Hostel Mint have <b>24 contestants</b> total, 12 in each team, 6 male and 6 female. Each contestant has a number written on their shoulder from 1 to 12 and their drinking name written on their arm.</p>
        <h2>How it Works:</h2>
